...
CASES: list[tuple[str, str, float, list[str]]] = [
    ...
    (
        ...
        1.0,
        ["glycosylation", "glycosylation", "A2", "B1", "B1", "B2", "B2", "B5", "C1", "C2", "C2", "C2", "C2", "D5", "malonic acid", "methanol", "methylation", "methylation", "methylation", "methylation", "glycosylation"],
    ),
    (
        "avilamycin A",
    ...
    (
        ...
        1.0,
        ["glycosylation", "glycosylation", "4-amino-2-hydroxybutanoic acid", "D5", "glycine", "glycosylation"],
    ),
    (
        "butirosin B",
        r"C1[C@@H]([C@H]([C@@H]([C@H]([C@@H]1NC(=O)[C@H](CCN)O)O)O[C@H]2[C@@H]([C@@H]([C@H](O2)CO)O)O)O[C@@H]3[C@@H]([C@H]([C@@H]([C@H](O3)CN)O)O)N)N",
    ...
    (
        ...
        0.74,
        # Default rule set is not able to parse the enediyne core, but should at least identify the glycosylation parts
        ["glycosylation", "glycosylation", "A1", "A5", "C1", "acetic acid", "carbonic acid", "ethanol", "iodination", "methylation", "methylation", "methylation", "methylation", "methylation", "methylation", "glycosylation", "glycosylation"]
    ),
    (
        "callystatin",
    ...
    (
        ...
        1.0,
        ["glycosylation", "glycosylation", "6-methylsalicylic acid", "A1", "B1", "C1", "C1", "C1", "C1", "C1", "C1", "C1", "C13", "D1", "D1", "D1", "acetic acid", "acetic acid", "chlorination", "glyceric acid", "glycolic acid", "methylation"],
    ),
    (
        "coelimycin P1",
    ...
    (
        ...
        1.0,
        ["glycosylation", "A", "A1", "A1", "B1", "B1", "C1", "C1", "C1", "C2", "D1", "D1", "D1", "heptanoic acid", "methylation", "oxidation", "pentanoic acid", "propanoic acid"],
    ),
    (
        "deschlorothricin",
        ...
        1.0,
        ["glycosylation", "glycosylation", "6-methylsalicylic acid", "A1", "B1", "C1", "C1", "C1", "C1", "C1", "C1", "C1", "C13", "D1", "D1", "D1", "acetic acid", "acetic acid", "glyceric acid", "glycolic acid", "methylation"],
    ),
    (
        "daptomycin",
    ...
    (
        ...
        1.0,
        ["glycosylation", "glycosylation", "A2", "B2", "B2", "B2", "B6", "D6", "methylation", "propanoic acid"]
    ),
    (
        "georatusin",
    ...
    (
        ...
        1.0,
        ["glycosylation", "glycosylation", "methylation", "glycosylation"],
    ),
    (
        "hymenosetin",
    ...
    (
        ...
        1.0,
        ["glycosylation", "glycosylation", "A6", "B2", "B2", "B2", "B2", "B2", "D2", "acetic acid", "acetic acid", "acetic acid", "methylation", "methylation"],
    ),
    (
        "latrunculin",
    ...
    (
        ...
        1.0,
        ["glycosylation", "glycosylation", "A2", "B2", "B2", "B2", "B6", "D6", "methylation", "methylation", "propanoic acid", "glycosylation"],
    ),
    (
        "micacocidin A",
